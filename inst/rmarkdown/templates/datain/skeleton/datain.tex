...
\titleformat{\section}[block]
  {\fontsize{15}{17}\bfseries\sffamily\color{hijau}}
  {\thesection}
  {0.4em}{}
\titleformat{\subsection}[block]
  {\fontsize{12}{14}\bfseries\sffamily\color{hijau}}
  {\thesubsection}
  {0.4em}{}
...
\definecolor{hijau}{rgb}{0.0, 0.42, 0.24}
\RequirePackage{url}
...
\pretitle{%
$if(branding)$%
\begin{textblock}{4}(1.9,0.85)\includegraphics[height=1.5cm]{}\end{textblock}
\vspace*{-.8cm}
$else$
\vspace*{.5cm}
$endif$
\LARGE\bfseries\color{hijau}}
